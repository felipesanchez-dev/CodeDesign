...
const Footer = () => {
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/in/felipereyessa",
      icon: LinkedInIcon,
    },
  ];
  ...
  const serviceLinks = [
    ...
    { name: "Aplicaciones Multiplataforma", href: "#servicios" },
    { name: "Software a la Medida", href: "#servicios" },
    { name: "Diseño UI/UX", href: "#servicios" },
    { name: "SEO Optimización", href: "#servicios" },
  ];

  return (
    <footer className="bg-[#0a0a0a] text-gray-300 lg:grid lg:grid-cols-5">
      <div className="relative hidden h-full lg:col-span-2 lg:block">
        {" "}
        <img
          src="/img/footerImg.jpg"
          alt="Imagen Decorativa Footer"
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <a
              ...
              className="mt-2 flex items-center space-x-2 text-2xl font-medium text-white hover:opacity-75 sm:text-3xl" // Texto blanco para contraste
            >
              <span>Saber Más</span>
            </a>

            <ul className="mt-4 space-y-1 text-sm text-gray-400">
              <li>Disponible para consultas</li>
            </ul>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <p className="font-medium text-white">Mis Servicios</p>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; {new Date().getFullYear()} Felipe Sánchez Dev. Todos los
              derechos reservados. {/* Año dinámico y corrección */}
            </p>
          </div>
        </div>
      </div>
